...
class Feature extends Component {
    ...
    if (this.state.dataSet.length === 0 && this.state.dataSet.length % 6 !== 0  && this.props.newOne && this.props.iconsDisplay === false) {
      this.props.setIcons()
	...
	render() {
		if (this.state.dataSet.length === 0 || this.state.dataSet.length % 6 !== 0) {
			...
			if (this.props.newOne && this.props.iconsDisplay === false) {
