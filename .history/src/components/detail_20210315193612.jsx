		...
		<div className="detail">
			...
			<section className="right-section">
				...
				<div className="detail-info detail-sex-date">
					...
					<div className="detail-font"><b>Gender:</b> {gender}</div>
				</div>
				<div className="detail-info detail-font"><b>Phone:</b> {phone}</div>
				<div className="detail-info detail-font"><b>Email:</b> {email}</div>
				<div className="detail-info detail-font"><b>Location:</b> {location}</div>
			</section>
		</div>
	)
}
