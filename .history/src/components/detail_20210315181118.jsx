		...
		<div className="detail">
			...
			<section className="right-section">
				<div className="detail-name">
					{name}
					<p className="detail-name2">(username:$ {username})</p>
				</div>
				<div className="detail-sex-date">
					<div className="detail-font">Date: {date}</div>
					<div className="detail-font">Sex: {sex}</div>
				</div>
			</section>
		</div>
	)
